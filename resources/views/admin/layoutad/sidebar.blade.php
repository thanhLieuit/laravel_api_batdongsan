 <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="assets/admin/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Bất Động Sản</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ route('admin.type-prodcut')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Loại Sản Phẩm</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('admin.product-utilitie')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('admin.support')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Bảng hổ trợ lỗi</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('admin.insert-error')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Thêm Tên lỗi</p>
                </a>
              </li>
